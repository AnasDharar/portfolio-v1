...
function Box({prop}) {
  return (
    <div className='group flex items-center justify-center gap-2 border border-neutral-700 hover:border-neutral-500 font-gabarito p-2 m-2 rounded-md duration-200 cursor-pointer'>
        <img src={`skills/${prop.image}.png`} alt={prop.name} className='h-5 w-auto object-cover group-hover:grayscale-0 grayscale duration-200' />
