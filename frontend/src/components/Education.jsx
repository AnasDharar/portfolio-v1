      ...
      <div className='flex min-h-15 gap-2'>
        ...
        <div className='flex flex-col md:flex-row w-full md:justify-between'>
          <div className='flex flex-col'>
            <h3 className='text-md md:text-lg text-neutral-200 font-gabarito font-bold duration-200'>{prop.college}</h3>
            <p className='text-neutral-300 text-sm duration-200'>{prop.degree}</p>
          </div>

          <div className='flex items-center'>
            <span className='text-neutral-300 justify-start text-[10px] md:text-sm duration-200 italic'>{prop.duration}</span>
          </div>
        </div>
      </div>
    </div>
